...
import ecommerce.api.security.JWT.JwtProvider;
import ecommerce.api.service.UserService;
import ecommerce.api.vo.request.LoginForm;
import ecommerce.api.vo.response.JwtResponse;
...
public class UserController {
    ...
    public ResponseEntity<Statistics> getStats(Principal principal) {
    ...
    public Page<User> findAll(@RequestParam(value = "page", defaultValue = "1") Integer page,
        ...
        return userService.findAllPageable(request);
    }
